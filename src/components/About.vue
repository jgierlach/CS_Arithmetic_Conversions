    ...
    <transition name="slide" appear>
      <div class="center white-background padding move-down z-depth-4">
        <h3>
          ...
          <a href="https://github.com/jgierlach/conversion_scripts" target="_blank">here</a>. If you have any questions or feedback feel free to <a @click="contact">reach out</a> to me.
        </h3>
      </div>
    </transition>
  </div>
