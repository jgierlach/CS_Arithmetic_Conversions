  ...
  <div>
    ...
    >
      <div class="col s12">
        ...
        <h3 :key="index" v-for="(operation, index) in binaryToDecimalConversionArr">{{ operation }}</h3>
    ...
    >
      <div class="col s12">
        <!-- Here is where we are displaying all the steps involved in the conversion -->
        <h3 :key="index" v-for="(operation, index) in decimalToBinaryConversionArr">{{ operation }}</h3>
