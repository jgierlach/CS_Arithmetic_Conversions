<template>
  <div class="container white-background padding move-down z-depth-4">
    ...
    <p class="flow-text center">+ _________________________</p>
    ...
    <p class="flow-text center">We begin by adding 0 + 1 = <span class="red-text">1</span></p>
    ...
    <p class="flow-text center">1 0 1 0 1</p>
    <p class="flow-text center">+ _________________</p>
    <p class="flow-text center red-text">1 1 1 1 1</p> 
   
    <p class="flow-text center">The final answer is <span class="red-text answer-font">11111</span>.</p>

    <p class="flow-text">Okay that one was kind've easy. There were no carries involved. Let's try another problem.</p>

    <p class="flow-text center"><strong>Example 2: what is 1011 + 11101?</strong></p>

    <p class="flow-text"><strong>Step 1.</strong> Again arrange them vertically and by place value.</p>
    ...
    <p class="flow-text center">The final answer is <strong><span class="red-text answer-font">101000</span></strong>.</p>

    <h4 class="center">Be sure to checkout out our <a @click="navigateToBinaryAddition">binary addition tool!</a></h4>
